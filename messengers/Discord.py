...
class Discord:
    def __init__(self, webhook:str, botname:str="April O'Neil", avatar:str="https://i.pinimg.com/originals/87/67/11/876711e56a0ef942cbb2f15844235f2e.jpg"):
    ...
    def send_message(self, message:str):
        ...
        req = Request(self.webhook, data, headers={'Content-Type': 'application/json','User-Agent': 'Mozilla/5.0 (X11; U; Linux i686) Gecko/20071127 Firefox/2.0.0.11'})
        urlopen(req).read()
