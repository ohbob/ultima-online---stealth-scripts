...
def gettiles2(radius):
    temp = []
    temp2 = []
    minable1 = (1339, 1340, 1341, 1342, 1343, 1344, 1345, 1346, 1347, 1348, 1349, 1350, 1351, 1352,
                1353, 1354, 1355, 1356, 1357, 1358, 1359, 1361, 1362, 1363, 1386) # caves 
    minable2 = (220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 230, 231, 236, 237,
    ...
    minable3 = (0x453B, 0x453C, 0x453D, 0x453E, 0x453F, 0x4540, 0x4541, 0x4542, 0x4543, 0x4544, 0x4545, 0x4546, 
                0x4547, 0x4548, 0x4549, 0x454A, 0x454B, 0x454C, 0x454D, 0x454E, 0x454F) # rocks

    for currenttile in minable1, minable2, minable3:
